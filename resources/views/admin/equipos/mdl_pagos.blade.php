    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="">
                    <a href="#" class="btn btn-danger btn-sm" onclick="nuevoPago()">
...
{{-- Modal - Nuevo --}}
<div class="modal fade" id="mdlNuevoPago" tabindex="-1" role="dialog" aria-labelledby="Nuevo" aria-hidden="true">

    <div class="modal-dialog modal-dialog-centered" role="document">

        <div class="modal-content">

            <form action="" method="POST" id="frmNuevoPago" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-4">
                                <label for="registracion">Pago de registro:</label>
                                <input type="text" name="registracion" id="registracion" placeholder="S/ 0.00" class="form-control" required readonly />
                            </div>
